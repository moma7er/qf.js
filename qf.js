               ...
               function show(count){
                   ...
                   question.innerHTML = `<h2><span id="qu">السؤال رقم : </span><span id="qq">${count + 1}</span><span id="nnn"> من : <span id="qn">${questions.length}</span> أسئلة </span>${questions[count].question}</h2>
            ...
            (function(){
               ...
               function toww(){
                   ...
                   if (e == B){
                       ...
                       boto.innerHTML += `<h2 class="h2n"><span id="qu"> إجابة السؤال رقم : </span><span id="qq">${count + 1}</span>${questions[count].question}</h2>
                       <ul class="option_grou">
                       <li class="op2"><span class="B">${questions[count].answer}</span><span id="lzcor"> إجابتك صحيحة </span></li>  
                       </ul>
                       <ul class="nft">
                       <li><a href="https://www.facebook.com"><img src='icon(1).png'/></a></li>
  <li style="color:#fff">👈تابعنا على👉</li>
  <li><a href="https://t.me/thanawy_2024"><img id="tjpg" src="ic_launcher.png" style="width:60px"></a></li>
                       </ul>`
                   }
                   if (e != B){
                       ...
                       <li class="op2"><span class="B">${questions[count].answer}</span><span id="lzcor">الإجابة الصحيحة</span></li>
                       </ul>
                       <ul class="nft">
                         <li><a href="https://www.facebook.com"><img src='icon(1).png'/></a></li>
  <li style="color:#fff">👈تابعنا على👉</li>
  <li><a href="https://t.me/thanawy_2024"><img id="tjpog" src="ic_launcher.png" style="width:60px"></a></li>
</ul>`;
                   }
                   count++
                   }
